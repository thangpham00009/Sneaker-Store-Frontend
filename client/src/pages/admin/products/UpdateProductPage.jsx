...
export default function UpdateProductPage() {
  ...
  const handleSubmit = async () => {
    ...
    selectedCategories.forEach((c) =>
      formData.append("categoryIds", Number(c.id))
    );

    // ảnh cũ: gửi lại những cái còn giữ
                ...
                {selectedCategories.map((c) => (
                  ...
                  >
                    ...
                    <X
                      ...
                      onClick={() =>
                        setSelectedCategories(selectedCategories.filter((x) => x.id !== c.id))
                      }
                    />
                  </span>
                ))}
